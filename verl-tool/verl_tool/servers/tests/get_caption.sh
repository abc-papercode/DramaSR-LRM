...
tool_type=speaker_rec_tool # separate by comma if you want to start multiple tool servers
...
# python -m verl_tool.servers.tests.test_get_caption_tool_videoqa python --url=http://$host:$port/get_observation