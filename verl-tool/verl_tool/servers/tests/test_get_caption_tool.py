...
def _send_test_request(url, trajectory_id, action, test_name):
    ...
    payload = {
        ...
        "actions": [action],
        "extra_fields": [{'video_uid':'TGom0uiW130', 'width':5,'data_source': 'videocaption_videomme',"fps":25}]
        # "extra_fields": [{'video_uid':'-tpms_BbjHA', 'width':4,'data_source': 'videocaption_cgbench', "fps":25}]
    }
