...
'''
CAPTION_BASE_PATH = '/home/QiuJihao/Workspace/RL/latest_code/private_model/cg_bench_code/caption_qwen_wsub_scale_frame'
CAPTION_BASE_PATH_VIDEOMME = '/home/QiuJihao/Workspace/RL/latest_code/private_model/videomme_code/caption_qwen_wsub_scale_frame_merged'
...
def get_tool_observation(
    ...
    if func_name == 'get_caption':
        ...
        if data_source == 'videocaption_cgbench':
            video_path = f'{CGBENCH_VIDEO_PATH}/{video_uid}.mp4'
        elif data_source == 'videocaption_videomme':
            video_path = f'{VIDEOMME_VIDEO_PATH}/{video_uid}.mp4'
        else:
            return None
        segment_id, query = args
        video_qa_observation = get_new_video_qa_observation(video_path, segment_id, query, width)
